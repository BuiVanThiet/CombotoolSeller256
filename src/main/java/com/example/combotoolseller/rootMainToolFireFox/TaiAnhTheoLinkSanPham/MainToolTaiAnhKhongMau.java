package com.example.combotoolseller.rootMainToolFireFox.TaiAnhTheoLinkSanPham;

import com.example.combotoolseller.BaseAll;
import com.example.combotoolseller.rootImplements.AfrodomImplement;
import com.example.combotoolseller.rootImplements.AmazonImplement;
import com.example.combotoolseller.rootImplements.DriverImplement;
import com.example.combotoolseller.rootImplements.TikTokImplement;
...
public class MainToolTaiAnhKhongMau extends BaseAll {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try {
            for (Map<String, String> row : excelData) {
                ...
                data.addAll(getWebTool(link,"taiAnhTheoLinkSanPhamKhongMau",driver,outputFolder,index,null,limitImage));
