...
import com.example.combotoolseller.rootServices.PromemerteesService;
...
public class PromemerteesImplement extends BaseAll implements PromemerteesService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) {
        ...
        Elements imgElements = doc.select("div.product.product--large.product--left.product--stacked div.grid__item.product__media-wrapper media-gallery slider-component.slider-mobile-gutter img");
        int startLink = 0;
