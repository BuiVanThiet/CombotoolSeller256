...
import com.example.combotoolseller.rootServices.BurgaService;
...
public class BurgaImplement extends BaseAll implements BurgaService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        String nameProduct = getNameProduct(driver,"h1.h-style");
        Thread.sleep(2000);
        ...
        if(nameProduct == null) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("h1.h-style")));
            nameProduct = getNameProduct(driver,"h1.h-style");
            if (nameProduct == null) {
        ...
        Elements imgElements = doc.select("div.embla__container button.d-block.js-prod-gal-carousel-thumb.embla__slide.embla__slide--auto.btn-reset img");
        int startLink = 0;
    ...
    public String getLinkProductByPage(WebDriver driver, String baseFolder, String limit) {
        ...
        while (checkQuantityCard < 10) {
            ...
            Elements productLinks = docLinkProduct.select("collection-product-grid-loader.block-rel div.col-thumb-wrapper global-product-thumbnail.flex a.prod-thumb");
            List<String> listLink = getListLinkProductComponent(productLinks,"https://burga.com");
