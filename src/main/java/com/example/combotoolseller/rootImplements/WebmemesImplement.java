...
import com.example.combotoolseller.rootServices.WebmemesService;
...
public class WebmemesImplement extends BaseAll implements WebmemesService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        ...
        Elements imgElements = doc.select("slider-component ul.thumbnail-list img");
        int startLink = 0;
