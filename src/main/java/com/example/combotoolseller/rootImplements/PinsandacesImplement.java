...
import com.example.combotoolseller.rootServices.PinsandacesService;
...
public class PinsandacesImplement extends BaseAll implements PinsandacesService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        String nameProduct = getNameProduct(driver,"h1.heading");
        Thread.sleep(2000);
        ...
        if(nameProduct == null) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("h1.heading")));
            nameProduct = getNameProduct(driver,"h1.heading");
            if (nameProduct == null) {
        ...
        for (String link: urlImage) {
            System.out.println("dang tải:"+link);
    ...
    public String getLinkProductByPage(WebDriver driver, String baseFolder, String limit) {
        ...
        while (checkQuantityCard < 10) {
            ...
            Elements productLinks = docLinkProduct.select("div.product-item-meta a");
            List<String> listLink = getListLinkProductComponent(productLinks,"https://pinsandaces.com");
            ...
            if(checkCloneModal == false) {
                boolean checkCloneSale = getClickAction(driver,"div[aria-label='Close popup']");
            ...
            if(checkClickNext == false) {
                System.out.println("KOthay nut nexxt");
                break;
            } else {
                quantityLinkMax = 0;
                checkQuantityCard = 0;
