...
import com.example.combotoolseller.rootServices.OrnamentallyyouService;
...
public class OrnamentallyyouImplement extends BaseAll implements OrnamentallyyouService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        String nameProduct = getNameProduct(driver,"h1.h2.product-single__title");
        Thread.sleep(2000);
        ...
        if(nameProduct == null) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("h1.h2.product-single__title")));
            nameProduct = getNameProduct(driver,"h1.h2.product-single__title");
            if (nameProduct == null) {
        ...
        Elements imgElements = doc.select("div.product__thumbs--scroller image-element img.image-element");
        int startLink = 0;
...
// Tìm phần tử footer
            ...
            Elements productLinks = docLinkProduct.select("div.grid__item-image-wrapper a");
            List<String> listLink = getListLinkProductComponent(productLinks,"https://ornamentallyyou.com");
