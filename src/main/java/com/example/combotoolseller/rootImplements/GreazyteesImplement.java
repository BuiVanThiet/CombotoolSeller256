...
public class GreazyteesImplement extends BaseAll implements GreazyteesService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        String nameProduct = getNameProduct(driver,"div.product-details__title");
        Thread.sleep(2000);
        ...
        if(nameProduct == null) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("div.product-details__title")));
            nameProduct = getNameProduct(driver,"div.product-details__title");
            if (nameProduct == null) {
        ...
        Elements imgElements = doc.select("scroll-slider-component div.media.media--has-lightbox a img");
        int startLink = 0;
    ...
    public String getLinkProductByPage(WebDriver driver, String baseFolder, String limit) {
        ...
        while (checkQuantityCard < 10) {
            ...
            Elements productLinks = docLinkProduct.select("a.product-item__title");
            List<String> listLink = getListLinkProductComponent(productLinks,"https://greazytees.com");
            ...
            boolean checkClickNext = clickNextPage(driver,"a[aria-label='Next page of products']");
