...
import com.example.combotoolseller.rootServices.HarperandblakeService;
...
public class HarperandblakeImplement extends BaseAll implements HarperandblakeService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        Thread.sleep(2000);
        String nameProduct = getNameProduct(driver,"h1.product-details-product-title");
        ...
        if(nameProduct == null) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("h1.product-details-product-title")));
            nameProduct = getNameProduct(driver,"h1.product-details-product-title");
            if (nameProduct == null) {
        ...
        Elements imgElements = doc.select("product-media#productMediaDesktop div.thumbnail-media--thumbnails div.swiper-wrapper div.swiper-slide div.responsive-image-wrapper img.theme-img");
        int startLink = 0;
    ...
    public String getLinkProductByPage(WebDriver driver, String baseFolder, String limit) {
        ...
        while (checkQuantityCard < 10) {
            ...
            Elements productLinks = docLinkProduct.select("theme-modal a.quick-add-button-variants-desktop[data-product-card-link]");
            List<String> listLink = getListLinkProductComponent(productLinks,"https://harperandblake.co.uk");
            ...
            boolean checkClickNext = clickNextPage(driver,"li a[aria-label='Go to next page']");
