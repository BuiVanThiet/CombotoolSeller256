...
import com.example.combotoolseller.rootServices.VinovogueService;
...
public class VinovogueImplement extends BaseAll implements VinovogueService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        ...
        Elements imgElements = doc.select("div.sf-media-nav div.nav-swiper-container div.swiper-wrapper div.swiper-slide div.sf-prod-media responsive-image img");
        if (imgElements.size() <= 0) {
            imgElements = doc.select("div.swiper-wrapper div.swiper-slide div.sf-prod-media responsive-image img");
        }
        int startLink = 0;
    ...
    public String getLinkProductByPage(WebDriver driver, String baseFolder, String limit) {
        ...
        while (checkQuantityCard < 10) {
            ...
            Elements productLinks = docLinkProduct.select("div.sf__pcard-image div.overflow-hidden div.flex a.block");
            List<String> listLink = getListLinkProductComponent(productLinks,"https://vinovogue.com");
