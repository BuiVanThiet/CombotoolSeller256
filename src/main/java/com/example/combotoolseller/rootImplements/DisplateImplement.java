...
import com.example.combotoolseller.rootServices.DisplateService;
...
public class DisplateImplement extends BaseAll implements DisplateService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        String nameProduct = getNameProduct(driver,"h1.HeroTitle_heading__c9hW0");
        Thread.sleep(2000);
        ...
        if(nameProduct == null) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("h1.HeroTitle_heading__c9hW0")));
            nameProduct = getNameProduct(driver,"h1.HeroTitle_heading__c9hW0");
            if (nameProduct == null) {
        ...
        Elements imgElements = doc.select("button.HeroSlider_thumbnailButton__OfA2q div.DefaultThumbnail_thumbnail__qyG_X div.DefaultThumbnail_artworkWrapper__lD0pb picture.ArtworkPicture_artworkPicture__ZLPSm img.ArtworkPicture_artworkPicture__ZLPSm");
        int startLink = 0;
        for (String url: getListImageComponent(driver,imgElements,"/\\d+x\\d+/", "/863x1200/")) {
            if (!limit.equals("")) {
...
//            break;
    ...
    public String getLinkProductByPage(WebDriver driver, String baseFolder, String limit) {
        ...
        while (checkQuantityCard < 10) {
            ...
            Elements productLinks = docLinkProduct.select("div.SectionWrapper_wrapper__FeZB1 div.MasonryFeed_masonryFeedGridContainer__2aefS div.MasonryGridItem_masonryGridItemContainer__DrxVh a.ElysiumLink_link__xHW5f.MasonryGridItem_masonryGridItemLink__7GV_Z");
            List<String> listLink = getListLinkProductComponent(productLinks,"https://displate.com");
            ...
            if(checkCloneModal == false) {
                boolean checkCloneSale = getClickAction(driver,"div.bz-background#iwwi div.bz-modal div.bz-sctn button.bz-close-btn");
