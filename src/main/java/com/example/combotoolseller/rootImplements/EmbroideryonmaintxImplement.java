...
public class EmbroideryonmaintxImplement extends BaseAll implements EmbroideryonmaintxService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        ...
        Elements imgElements = doc.select("ul.product__media-list li.product__media-item div.product-media-container modal-opener.product__modal-opener div.product__media img.image-magnify-lightbox");
        int startLink = 0;
    ...
    public String getLinkProductByPage(WebDriver driver, String baseFolder, String limit) {
        ...
        while (checkQuantityCard < 10) {
            ...
            Elements productLinks = docLinkProduct.select("ul#product-grid li.grid__item div.product-card-wrapper div.card div.card__content div.card__information h3.card__heading.h5 a.full-unstyled-link");
            List<String> listLink = getListLinkProductComponent(productLinks,"https://embroideryonmaintx.com");
