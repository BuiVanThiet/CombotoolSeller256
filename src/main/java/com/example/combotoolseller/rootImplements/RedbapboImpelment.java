...
import com.example.combotoolseller.rootServices.RedbapboService;
...
public class RedbapboImpelment extends BaseAll implements RedbapboService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        String nameProduct = getNameProduct(driver,"h1.styles_box__54ba70e3.styles_text__5c7a80ef.styles_display3__5c7a80ef");
        Thread.sleep(2000);
        if(nameProduct == null) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("h1.styles_box__54ba70e3.styles_text__5c7a80ef.styles_display3__5c7a80ef")));
            nameProduct = getNameProduct(driver,"h1.styles_box__54ba70e3.styles_text__5c7a80ef.styles_display3__5c7a80ef");
            if (nameProduct == null) {
        ...
        Elements imgElements = doc.select("div.styles_box__54ba70e3.ProductPreviewsCarousel_box__k1Po4 img");
        int maxLink = 0;
        int startLink = 0;
