...
@Service
public class TodaysuniformImplement extends BaseAll implements TodaysuniformService {
    ...
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        ...
        Elements imgElements = doc.select("slider-component ul.product__media-list li.product__media-item img \n");
