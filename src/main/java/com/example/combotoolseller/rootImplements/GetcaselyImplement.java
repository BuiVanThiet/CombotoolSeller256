...
import com.example.combotoolseller.rootServices.GetcaselyService;
...
public class GetcaselyImplement extends BaseAll implements GetcaselyService {
    ...
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        String nameProduct = getNameProduct(driver,"div.title h1");
        Thread.sleep(2000);
        ...
        if(nameProduct == null) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("div.title h1")));
            nameProduct = getNameProduct(driver,"div.title h1");
            if (nameProduct == null) {
        ...
        Elements imgElements = doc.select("div.slick-list.draggable div.slick-track div.slick-slide img");
        int startLink = 0;
