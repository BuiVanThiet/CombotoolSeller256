...
import com.example.combotoolseller.rootServices.SellmerchandiseService;
...
public class SellmerchandiseImplement extends BaseAll implements SellmerchandiseService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        ...
        Elements imgElements = doc.select("div.t4s-carousel__nav-item img");
        int startLink = 0;
