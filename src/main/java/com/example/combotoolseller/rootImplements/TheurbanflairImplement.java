...
import com.example.combotoolseller.rootServices.TheurbanflairService;
...
public class TheurbanflairImplement extends BaseAll implements TheurbanflairService {
    @Override
    public String getDowloadImage(WebDriver driver, String linkRoot, String baseFolder, int index, String limit) throws IOException, InterruptedException {
        ...
        Elements imgElements = doc.select("div.slick-list.draggable div.slick-track div.prThumb.product-single__thumbnails-item.slick-slide a.product-single__thumbnail");
        int startLink = 0;
        for (String url: getListImageComponent(driver,imgElements,"_50x.jpg\\?v=.*", ".jpg")) {
            if (!limit.equals("")) {
...
//            break;
    ...
    public String getLinkProductByPage(WebDriver driver, String baseFolder, String limit) {
        ...
        while (checkQuantityCard < 10) {
            ...
            Elements productLinks = docLinkProduct.select("div.grid-view-item div.grid-view_image a.grid-view-item__link");
            List<String> listLink = getListLinkProductComponent(productLinks,"https://theurbanflair.com");
            ...
            boolean checkClickNext = clickNextPage(driver,"ul li.usf-sr-pages__next a[title='Next page']");
